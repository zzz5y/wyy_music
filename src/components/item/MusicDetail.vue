<template>
  ...
  <div class="detailContent" v-show="!isLyricshow">
    ...
    <img :src="musicList.al.picUrl" class="img_ar" @click="isLyricshow=true" :class="{img_ar_active:!isbtnShow,img_ar_paused:isbtnShow}"/>
  </div>
  <div class="musicLyric" ref="musicLyric" v-show="isLyricshow">
    <p v-for="(item,i) in lyric" :key="item" :class="{active:(currentTime*1000>=item.time&&currentTime*1000<item.pre)}" @click="isLyricshow=false;">{{ item.lrc }}</p>
  </div>
